...
export const getUpdatedProducts = ( existingProductsInCart, product, qtyToBeAdded, newQty = false ) => {
	...
	const id= product.productId?product.productId:product.databaseId

	const productExitsIndex = isProductInCart( existingProductsInCart,id );
...
console.log("DATA A FORMATO",data)
